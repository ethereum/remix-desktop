...
function warnLatestVersion(current) {
    return __awaiter(this, void 0, void 0, function* () {
        const res = yield fetch('https://api.github.com/repos/ethereum/remix-desktop/releases/latest');
        let latest = (yield res.json()).tag_name;
...
const setupApplicationMenu = () => __awaiter(void 0, void 0, void 0, function* () {
    let status = "";
    try {
        status = yield warnLatestVersion(version);
    }
    catch (e) {
...
function getFolder(client) {
    if (client.currentSharedFolder)
        return client.currentSharedFolder;
